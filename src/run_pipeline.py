...
# Pipeline order 
PIPELINE = [
    ("1.0 ANN — rand A",  "notebook/model/1.0-fc-rand-A.ipynb"),
    ("1.1 ANN — rand B",  "notebook/model/1.1-fc-rand-B.ipynb"),
    ("1.2 ANN — rand C",  "notebook/model/1.2-fc-rand-C.ipynb"),
    ("1.3 ANN — rand D",  "notebook/model/1.3-fc-rand-D.ipynb"),
    ("1.4 ANN — chro A",  "notebook/model/1.4-fc-chro-A.ipynb"),
    ("1.5 ANN — chro B",  "notebook/model/1.5-fc-chro-B.ipynb"),
    ("1.6 ANN — chro C",  "notebook/model/1.6-fc-chro-C.ipynb"),
    ("1.7 ANN — chro D",  "notebook/model/1.7-fc-chro-D.ipynb"),
]
